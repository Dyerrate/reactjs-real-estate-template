    ...
    return (
        <header className="text-gray-600 bg-slate-100 shadow shadow-slate-200 body-font lg:px-10 sticky top-0 z-10">
                <div className="container mx-auto flex justify-between px-5 py-4 items-center">
                    <Link href="/" className="flex w-fit title-font font-medium items-center text-gray-900">
                    ...
                    <div className="mt-2">
                        ...
                        <nav className={openSidebar ? "absolute transform translate-x-0 opacity-100 left-0 top-0 bg-white md:bg-transparent md:ml-auto md:relative md:w-full w-1/2 h-screen md:h-fit md:p-0 p-6 transition-all duration-200": "absolute transform -translate-x-24 md:translate-x-0 md:opacity-100 opacity-0 left-0 top-0 bg-white md:bg-transparent md:ml-auto md:relative md:w-full w-1/2 h-screen md:h-fit md:p-0 p-6 transition-all duration-200"}>
                            ...
                            <ul className="md:flex flex-wrap items-center text-base justify-center md:mt-0 mt-6">
                                ...
                                <li className="md:mt-0 mt-4">
                                    <Link href="/listing" className="md:mx-6 hover:text-indigo-500" onClick={() => setOpenSidebar(false)}>All Property</Link>
                                </li>
                            </ul>
                        </nav>
                    </div>
