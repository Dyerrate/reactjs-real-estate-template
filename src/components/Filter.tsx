...
const Filter = () => {
  const { cities, bedRooms, handleFilterChange, selectedFilter } =
    ...
    <div className="flex flex-wrap justify-center">
      <div className="my-2">
        <select
          ...
          onChange={(e) =>
            handleFilterChange({ ...selectedFilter, price: e.target.value })
          }
        >
      ...
      <div className="m-2">
        <select
          ...
          onChange={(e) =>
            handleFilterChange({ ...selectedFilter, city: e.target.value })
          }
        >
